...
public:
    ...
    void setPickHandler(gui::common::PickHandler *);
    ...
    void updateOperation(gui::common::MOUSE_BUTTON button, const std::string &id);
...
protected:
    void updateOperation(gui::common::Operation* op);
    gui::common::PickHandler *pickHandler;
    std::map< int, std::string > mapIndexOperation;

    type::fixed_array< std::string, gui::common::NONE > usedOperations;
};
